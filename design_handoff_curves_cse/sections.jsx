  ...
  return (
    <>
      <nav className={`nav ${scrolled ? 'scrolled' : ''}`}>
        ...
        <a href="#trial" className="btn btn-primary nav-cta-desktop">
          Bilan de forme gratuit! <span className="arrow">→</span>
        </a>
      ...
      <div className={`mobile-menu ${menuOpen ? 'open' : ''}`}>
        <div className="mobile-menu-inner">
          <a href="#method" onClick={close}>La Méthode</a>
          <a href="#program" onClick={close}>Le Programme</a>
          <a href="#coaches" onClick={close}>Coachs</a>
          <a href="#pricing" onClick={close}>Tarifs</a>
          <a href="#faq" onClick={close}>FAQ</a>
          <a href="#trial" className="btn btn-primary" onClick={close} style={{ marginTop: 24, justifyContent: 'center' }}>
...
function Hero() {
  return (
    <section className="hero" id="top">
      ...
      <div className="hero-meta mono" style={{ color: 'rgb(255, 255, 255)' }}>
      ...
      <div className="hero-inner">
        ...
        <div>
          <p className="hero-lede" style={{ margin: '3px' }}>
...
function Coaches() {
  const team = [
  { name: 'Maud', role: 'Manager', img: 'img/coach-maud.png' },
  { name: 'Virginie', role: 'Assistante Manager & Coach', img: 'img/coach-virginie.png' },
  { name: 'Axelle', role: 'Coach', img: 'img/coach-axelle.png' },
  { name: 'Béatrice', role: 'Coach', img: 'img/coach-beatrice.png' },
  { name: 'Camille', role: 'Coach', img: 'img/coach-camille.png' }];
        ...
        <div className="cta-grid">
          ...
          <form className={`booking ${sent ? 'sent' : ''}`} onSubmit={onSubmit}>
            <div className="booking-fields">
              <h3>RÉSERVER UN BILAN DE FORME GRATUITEMENT</h3>
              <div className="booking-sub">On vous rappelle dans la journée pour caler le créneau.</div>
