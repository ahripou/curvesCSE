// Curves-style wordmark logo — stylized script "Curves" with tagline
function Logo({ size = 36, color = "var(--brand)", ink = "var(--ink)", withWord = true, wordColor, location = "Court-Saint-Étienne" }) {
...
// Decorative curved arcs — the graphic motif
function Arc({ size = 400, stroke = 80, color = "var(--brand)", style = {}, sweep = 180, start = 0 }) {
